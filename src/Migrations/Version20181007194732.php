 ...
 */
class Version20181007194732 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE hours ADD is_reserved SMALLINT NOT NULL, ADD is_in_establishment_opening_hour SMALLINT NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE hours DROP is_reserved, DROP is_in_establishment_opening_hour');
    }
}
